...
<div class="container">
    ...
    <form action="/RouteDriverServlet" method="post" role="form" data-toggle="validator" >
        ...
        <div class="form-group col-xs-4">
            ...
            <label for="driverPassword" class="control-label col-xs-4"><fmt:message key="admin.add.user.visitor.password"/>:</label>
    ...
    <br>
    <a href="driverMainPage.jsp"><button type="submit" class="btn btn-secondary  btn-md"><fmt:message key="back.to.main.page"/></button></a>
    <br>
    <br>
