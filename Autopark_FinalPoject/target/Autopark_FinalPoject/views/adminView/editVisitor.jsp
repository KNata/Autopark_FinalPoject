...
<div class="container">
    ...
    <form action="/VisitorServlet" method="post" role="form" data-toggle="validator" >
        ...
        <h3><fmt:message key="admin.add.user.welcome.warning"/></h3>

        <div class="form-group col-xs-4">

            <label for="visitorLogin" class="control-label col-xs-4"><fmt:message key="admin.add.user.visitor.login"/>:</label>
            <input type="text" name="visitorLogin" id="visitorLogin" class="form-control" value="${visitor.visitorLogin}" required="true"/>
            <br>
            <label for="visitorPassword" class="control-label col-xs-4"><fmt:message key="admin.add.user.visitor.password"/>:</label>
            ...
            <label for="visitorRole" class="control-label col-xs-4"><fmt:message key="admin.add.user.visitor.visitor.role"/>:</label>
